import { c as x } from './react-CcLub2mw.js';
var B = {};
/*!
 *  howler.js v2.2.4
 *  howlerjs.com
  ...
  (function () {
    ...
    _.prototype = {
      ...
      play: function (e, t) {
        ...
        if (n._webAudio) {
          ...
          r.state === 'running' && r.ctx.state !== 'interrupted'
            ? O()
            : ((n._playLock = !0), n.once('resume', O), n._clearTimer(a._id));
        } else {
          var H = function () {
            ((v.currentTime = m),
            ...
            try {
              ...
              if (
                ...
                (T instanceof Promise || typeof T.then == 'function')
                  ...
                  : t || ((n._playLock = !1), k(), n._emit('play', a._id)),
                (v.playbackRate = a._rate),
                v.paused)
              ) {
                n._emit(
          ...
          if (v.readyState >= 3 || M) H();
          else {
            ((n._playLock = !0), (n._state = 'loading'));
            var P = function () {
              ((n._state = 'loaded'),
                H(),
                v.removeEventListener(r._canPlayEvent, P, !1));
            };
            (v.addEventListener(r._canPlayEvent, P, !1), n._clearTimer(a._id));
          }
        }
        return a._id;
      },
      ...
      _emit: function (e, t, n) {
        for (var o = this, u = o['_on' + e], l = u.length - 1; l >= 0; l--)
    ...
    ((I.Howler = r),
      (I.Howl = _),
      typeof x < 'u'
        ? ((x.HowlerGlobal = g), (x.Howler = r), (x.Howl = _), (x.Sound = i))
        : typeof window < 'u' &&
        ...
        return function (_) {
          ...
          return (
            ...
            (i._pannerAttr = {
              ...
              distanceModel:
                typeof _.distanceModel < 'u' ? _.distanceModel : 'inverse',
...
export { B as h };
//# sourceMappingURL=sounds-DWuT-O2e.js.map
